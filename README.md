...
| **project-scripts** | Discovers, catalogs, and manages project scripts (install, download, build, setup, clean). Scans conventional script locations, detects AI-generated and user-created scripts, and generates missing standard scripts. | | | |
