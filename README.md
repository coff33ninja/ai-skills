...
| **receiving-code-review** | Teaches how to receive review feedback properly — verify-before-implement on every comment, different skepticism levels by source, evidence-based pushback, no performative agreement. Prevents blindly implementing review suggestions. | | | |
