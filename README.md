...
| **shipping-and-launch** | Pre-launch checklists, staged rollouts (canary → 10% → 50% → 100%), rollback plans, feature flag verification. Complements release-changelog by covering the deployment and launch process. | | | |
