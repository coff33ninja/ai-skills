...
- **skill-loader** — Load this skill alongside universal-format-lint to ensure related skills (dont-kill-tokens, follow-existing-patterns, self-validate) are activated for efficient formatting tasks.
